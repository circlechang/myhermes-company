...
export const mockAgents: Agent[] = [
  { id: 'a1', name: '小編', profile: 'editor', title: '內容編輯', description: '負責選題、文案與發布', model: 'claude-sonnet-4', enabled: true, soul_excerpt: '你是一位注重事實的內容編輯。' },
  { id: 'a2', name: '研究員', profile: 'researcher', title: '市場研究', description: '蒐集資料與整理洞察', model: 'gpt-5', enabled: true, soul_excerpt: '你先找證據，再給結論。' },
  { id: 'a3', name: '客服', profile: 'support', title: 'LINE 客服', description: '回覆 LINE OA 訊息', model: 'claude-haiku-4', enabled: false, soul_excerpt: '' },
]
