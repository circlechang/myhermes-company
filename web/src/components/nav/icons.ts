...
import {
  Activity, ArrowUpCircle, Bot, Cable, CalendarClock, ChevronLeft, ChevronRight, Circle, Code2, Compass, Eye, FileText, Filter, Folder, HelpCircle, Inbox,
...
export const ICONS: Record<string, LucideIcon> = {
  Activity, ArrowUpCircle, Bot, Cable, CalendarClock, ChevronLeft, ChevronRight, Code2, Compass, Eye, FileText, Filter, Folder, HelpCircle, Inbox, Info,
