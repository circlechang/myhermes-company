...
import {
  Activity, ArrowUpCircle, Bot, Cable, CalendarClock, Circle, Code2, Compass, FileText, HelpCircle, Inbox, LayoutDashboard, LogOut, Menu, MessageSquare,
...
export const ICONS: Record<string, LucideIcon> = {
  Activity, ArrowUpCircle, Bot, Cable, CalendarClock, Code2, Compass, FileText, HelpCircle, Inbox, LayoutDashboard, LogOut, Menu, MessageSquare, Mic, Moon,
