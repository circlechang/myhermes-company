...
const zhTW = {
  ...
  groupchat: {
    ...
    inviteCode: '邀請碼', join: '加入', noRooms: '還沒有房間，建一個或輸入邀請碼', pickRoom: '選一個房間，或建立新房間',
    ...
    displayName: '顯示名稱', profile: 'Profile', model: '模型', modelDefault: '（用 profile 預設）', rolePrompt: '角色提示',
...
const en = {
  ...
  groupchat: {
    ...
    inviteCode: 'Invite code', join: 'Join', noRooms: 'No rooms yet', pickRoom: 'Pick a room or create one',
    ...
    displayName: 'Display name', profile: 'Profile', model: 'Model', modelDefault: '(profile default)', rolePrompt: 'Role prompt',
